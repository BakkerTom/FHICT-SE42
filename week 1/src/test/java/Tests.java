...
public class Tests {
    ...
    public void assignmentThree() throws Exception {
        ...
        em.persist(account); // Throws PersistenceException

        // Er onstaat een PersistencetException omdat het id is
        // aangepast wat het object transient maakt.
        // Hibernate ziet verschil tussen transient en detached objecten
        // persist werkt enkel met detached objecten
         ...
         * (i.e. to write changes to the database)."
         */
        em.merge(account);
        ...
        em.getTransaction().rollback();
        //De transactie kan nu wel gecommit worden
    }
